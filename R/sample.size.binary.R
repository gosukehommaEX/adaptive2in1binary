...
#
## The "sample.size.binary" function aims to calculate the required sample size for two-arm trials with binary endpoints.
...
#
## sample.size.binary has the following arguments.
...
## sample.size.binary returns the R data.frame format including the following values 
#  p1:         true probability of responders for group 1
#  p2:         true probability of responders for group 2
...
# (1) The one-sided Pearson chi-squared test (Chisq)
# sample.size.binary(p1 = 0.4, p2 = 0.2, r = 2, alpha = 0.025, tar.power = 0.8, Test = 'Chisq')
...
#
# (2) The Fisher exact test (Fisher)
# sample.size.binary(p1 = 0.5, p2 = 0.2, r = 3, alpha = 0.025, tar.power = 0.9, Test = 'Fisher')
#    p1  p2 r alpha tar.power   Test     Power  N1 N2   N
...
#
# (3) The Fisher mid-p test (Fisher-midP)
# sample.size.binary(p1 = 0.6, p2 = 0.3, r = 2, alpha = 0.025, tar.power = 0.9, Test = 'Fisher-midP')
#    p1  p2 r alpha tar.power        Test     Power N1 N2   N
...
#
# (4) The Z-pooled exact unconditional test (Z-pool)
# sample.size.binary(p1 = 0.3, p2 = 0.2, r = 1, alpha = 0.025, tar.power = 0.8, Test = 'Z-pool')
#    p1  p2 r alpha tar.power   Test     Power  N1  N2   N
...
#
# (5) The Boschloo exact unconditional test (Boschloo)
# sample.size.binary(p1 = 0.7, p2 = 0.2, r = 4, alpha = 0.025, tar.power = 0.8, Test = 'Boschloo')
#    p1  p2 r alpha tar.power     Test     Power N1 N2  N
