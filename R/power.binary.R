...
#
## The "power.binary" function aims to calculate power for two-arm trials with binary endpoints.
...
#
## power.binary has the following arguments.
...
#
## power.binary returns the power. If the user specifies vectors of p1 and p2, a vector of powers will be returned.
###################################################### How to use ######################################################
# library(Exact)
# library(exact2x2)
...
#
# (3) The Fisher mid-p test (Fisher-midP)
# power.binary(p1, p2, N1, N2, alpha, Test = 'Fisher-midP')
...
#
# (4) The Z-pooled exact unconditional test (Z-pool)
# power.binary(p1, p2, N1, N2, alpha, Test = 'Z-pool')
...
#
# (5) The Boschloo exact unconditional test (Boschloo)
# power.binary(p1, p2, N1, N2, alpha, Test = 'Boschloo')
