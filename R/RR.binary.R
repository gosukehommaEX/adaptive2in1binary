...
#
## The "RR.binary" function aims to show a rejection region (RR) for two-arm trials with binary endpoints.
...
#
## RR.binary has the following arguments.
...
#
## RR.binary returns the RR in R matrix format.
###################################################### How to use ######################################################
# N1 = 20
# N2 = 10
# alpha = 0.025
# Test = 'Boschloo'
# RR.binary(N1, N2, alpha, Test)
